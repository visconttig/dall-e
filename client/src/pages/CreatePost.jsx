    ...
    const generateImage = async () => {
        if(form.prompt){
            try {
                ...
                setForm({...form, photo: `data:imgage/jpeg;base64,${data.photo}`});
            } catch (error) {
                alert(error);
            } finally {
        ...
        <section className="max-w-7xl mx-auto"  >
            ...
            <form className="mt-16 max-w-3xl"
                ...
                <div className="relative bg-gray-50 border border-gray-300
                     text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-4 h-64 flex justify-center items-center" >
                        {form.photo ? (
                            <img src={form.photo}
                                alt={form.prompt}
